...
void SetForgroundColor_Unix(RF_Type::UInt8 R,
                            RF_Type::UInt8 G,
                            RF_Type::UInt8 B)
{
  auto escape = RF_Type::String::Format("\x1b[38;2;%u;%u;%um"_rfs, R, G, B);
  fwrite(escape.c_str(),sizeof(RF_Type::UInt8), escape.Length(), stdout);
}
...
void ResetForgroundColor_Unix()
{
  static auto resetCommand = "\x1b[39m"_rfs;  
  fwrite(resetCommand.c_str(),sizeof(RF_Type::UInt8), resetCommand.Length(), stdout);
}
...
//  WriteLine = ::WriteLine_Windows;
  Write = ::Write_Unix;
  SetForgroundColor = ::SetForgroundColor_Unix;
//  SetBackgroundColor = ::SetBackgroundColor_Windows;
//  SetModifier = ::SetModifier_Windows;
  ResetForgroundColor = ::ResetForgroundColor_Unix;
